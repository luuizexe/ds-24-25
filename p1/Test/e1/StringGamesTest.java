...
public class StringGamesTest {
    ...
    @Test
    void esAbecedarioCorrectoTest() {
        assertTrue(StringGames.esAbecedarioCorrecto("abcdefghijklmnopqrstuvwxyz"));
        assertFalse(StringGames.esAbecedarioCorrecto(null));
        assertFalse(StringGames.esAbecedarioCorrecto("aabcdefghijklmnopqrstuvwxyz"));
        assertFalse(StringGames.esAbecedarioCorrecto("abcde12345"));
        assertFalse(StringGames.esAbecedarioCorrecto("abcdefghijklmnopqrstuvwxy"));
    }
